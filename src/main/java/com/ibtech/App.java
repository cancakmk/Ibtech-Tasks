...
public class App {
	public static void updateDatas(List<Customer> customerList, List<Account> accountList, List<Address> addressList,
	...
	public static void createDatas(List<Customer> customerList, List<Account> accountList, List<Address> addressList,
			List<Phone> phoneList) {
		CustomerDbo customerDao = new CustomerDbo();
		AccountDbo accountDao = new AccountDbo();
		AddressDbo addressDao = new AddressDbo();
	...
	public static void getAllDatas(List<Customer> customerList, List<Account> accountList, List<Address> addressList,
			List<Phone> phoneList) {
		CustomerDbo customerDao = new CustomerDbo();
		AccountDbo accountDao = new AccountDbo();
		AddressDbo addressDao = new AddressDbo();
	...
	public static void deleteAllDatas(List<Customer> customerList, List<Account> accountList, List<Address> addressList,
			List<Phone> phoneList) {
		CustomerDbo customerDao = new CustomerDbo();
		AccountDbo accountDao = new AccountDbo();
		AddressDbo addressDao = new AddressDbo();
	...
	public static void main(String[] args) {
		...
		String serviceName = "Add_customer_info";

		Bag bagAdd = new Bag();
		bagAdd.put(BagKey.CNAME, "Okan");
		bagAdd.put(BagKey.CSURNAME, "Saraç");

		Bag customerBag = CommandExecuter.executer(serviceName, bagAdd);

		System.out.println("WantedCommand: " + commenddbo.getCommand(serviceName));
